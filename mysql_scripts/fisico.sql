...
(
    ...
    circunstancia         ENUM ('ACIDENTE',
        ...
        'HOMICIO',
        'OUTROS',
        'IGNORADO')                   DEFAULT 'IGNORADO',
    isObitoFetal          BOOLEAN     DEFAULT FALSE,
    houveAlteracaoCausa   BOOLEAN     DEFAULT FALSE,
    obitoEmRelacaoAoParto ENUM ('ANTES',
        'DURANTE',
        'DEPOIS',
        'IGNORADO' )                  DEFAULT 'IGNORADO',
    crmAtestante          VARCHAR(10),
    CONSTRAINT obito_pk PRIMARY KEY (idObito),
...
(
    ...
    tipoResgateInformacao ENUM ('NAO_ACRESCENTOU',
        'SIM_NOVAS_INFOS',
        'SIM_CORRECAO')          DEFAULT 'NAO_ACRESCENTOU',
    dtInicio              DATE,
    dtCadastro            DATE,
    dtConclusao           DATE,
